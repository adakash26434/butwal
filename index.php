  ...
  <div
    ...
    <div class="container" style="position:relative;height:100%;display:flex;align-items:center;padding-top:2rem;">
      <div :class="cur==<?=$_hk?>?'hero-ca':''" style="max-width:36rem;">
        <h1 class="hero-h1" style="font-family:var(--font-display);font-size:clamp(2rem,4.5vw,2.875rem);font-weight:800;color:#fff;line-height:1.1;margin:0 0 .875rem;letter-spacing:-.025em;text-shadow:0 4px 20px rgba(0,0,0,.6), 0 2px 8px rgba(0,0,0,.5);">
          <?= nl2br(e($_hs['title'])) ?>
        </h1>
